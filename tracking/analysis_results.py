...
trackers.extend(trackerlist(name='test', parameter_name='vitb_256_mae_ce_32x4_ep300_hybrid', dataset_name=dataset_name,
                            run_ids=None, display_name='Test256_multi_data'))
...
trackers.extend(trackerlist(name='test', parameter_name='vitb_256_mae_ce_32x4_ep300_hybrid_ef', dataset_name=dataset_name,
...
trackers.extend(trackerlist(name='test', parameter_name='vitb_256_mae_ce_32x4_ep300_hybrid_hw_mf_old', dataset_name=dataset_name,
                            run_ids=None, display_name='Test256_hybrid_hw_mf_old'))
trackers.extend(trackerlist(name='test', parameter_name='vitb_256_mae_ce_32x4_ep300_hybrid_hw_mf_co', dataset_name=dataset_name,
                            run_ids=None, display_name='Test256_hybrid_hw_mf_co'))
trackers.extend(trackerlist(name='test', parameter_name='vitb_256_mae_ce_32x4_ep300_hybrid_hw_mf_co_old', dataset_name=dataset_name,
                            run_ids=None, display_name='Test256_hybrid_hw_mf_co_old'))
...
# plot_results(trackers, dataset, dataset_name, merge_results=True, plot_types=('success', 'norm_prec', 'prec'), skip_missing_seq=True, force_evaluation=True, 
            #  plot_bin_gap=0.05)
