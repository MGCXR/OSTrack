...
def convert_model(model_file, inputs_dict=None, target="llvm", path='./tmp_net/', model_type='Tensorflow',qconf=None, outputs=None, device=0, build_mode="abc_only", profiler=False, serialize=False):
    ...
    out_path = offline_builder.build(model.graph, model.params,qconf=qconf, out_path=path,serialize=serialize, build_mode=build_mode, profiler=profiler)
