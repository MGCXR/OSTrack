...
def build_test(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('Test' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    elif cfg.MODEL.BACKBONE.TYPE == 'vit_hybrid_patch16_224_ce_mf':
        backbone = vit_hybrid_patch16_224_ce_mf(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
                                            ce_loc=cfg.MODEL.BACKBONE.CE_LOC,
                                            ce_keep_ratio=cfg.MODEL.BACKBONE.CE_KEEP_RATIO,
                                            )
